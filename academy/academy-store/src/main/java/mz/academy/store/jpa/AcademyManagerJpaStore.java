...
public class AcademyManagerJpaStore implements DefaultStore<AcademyManager> {
    ...
    public void update(AcademyManager academyManager) {
        ...
        Optional<AcademyManagerEntity> optAcademyManagerEntity = academyManagerRepository.findById(academyManager.getId());
